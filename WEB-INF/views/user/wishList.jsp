	...
	<div id="wrapper">
		...
		<div id="main">
			<div class="inner">
				...
				<section>
				<h2>my <i class="fa-solid fa-star fa2xl" style="color: #fff370;"></i> list</h2>
									...
									<div class="camping_data">
										...
										<p>
											<i class="fa-solid fa-eye fa-xs"
												style="color: #5c5c5c; margin-right: 3px;"></i>
											${item.campView }
										</p>
					...
					<div class="section-pagination">
						<ul class="pagination">
							<c:choose>
								...
								<c:otherwise>
									<li><a href="camping.do?cpage=${ pi.startPage -1 }"
							...
							<c:forEach var="page" begin="${pi.startPage}" end="${pi.endPage}">
								<li><a class="page" href="camping.do?cpage=${page}">${page}
								</a></li>
							</c:forEach>
							...
							<c:choose>
								...
								<c:when test="${pi.endPage eq pi.maxPage}">
									<li><a href="camping.do?cpage=${pi.maxPage}"
										class="button">Next</a></li>
								</c:when>
								<c:otherwise>
									<li><a
										href="camping.do?cpage=${pi.currentPage + 1}&campAmenity=${campAmenity}&searchTxt=${searchTxt}&campTag=${campTag}&campAddress${campAdderess}&category${category}&campKeyword${campKeyword}&campType${campType}"
										class="button">Next</a></li>
								</c:otherwise>
							</c:choose>
						</ul>
